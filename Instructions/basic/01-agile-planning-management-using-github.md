...
1. **[マイルストーン]** ページで、**[マイルストーンの作成]** を選択します。
1. **[マイルストーンの作成]** ページで、次の操作を実行します。
...
1. リポジトリ ページで、**[プロジェクト]** タブを探して選択します。
1. **[新しいプロジェクト]** を選択します。
...
1. **[DevOps Core Intro Project]** ページで、現在選択されている **[バックログ]** タブの近くにある **[ボード]** タブを選択します。

   > **注:** さまざまなオプションを使用して、テーブル、ボード、ロードマップのビューを簡単に切り替えることができます。
...
1. **[ラベル]** を選択し、**[項目の選択]** ドロップダウン リストで **[拡張機能]** を選択します。
1. **[マイルストーン]** を選択して、**[項目の選択]** ドロップダウン リストで、**[アルファ リリース]** を選択します。
...
1. **[DevOps Core Intro Project]** ページの、アバター アイコンの真下、省略記号アイコンの近くにある **[ワークフロー]** を選択します。
