...
1. **[仮想マシン]** を選択します。
   ...
   ![構成された仮想マシンの作成のスクリーンショット。](media/create-virtual-machine.png)

1. **[基本]** タブで、次のアクションを実行してから、**[管理]** を選択します。
   ...
   > **注**: 仮想マシンの特定の**サイズ**を探していて、それがドロップダウン リストに表示されない (一覧に推奨サイズのみが表示される) 場合は、**[すべてのサイズを表示]** リンクをクリックし、**[VM サイズを選択します]** ページの **[VM サイズで検索してください...]** テキスト ボックスに探しているサイズを入力してサイズを検索し、それを選択して、ページ下部の **[選択]** ボタンをクリックします。
